...
export function Toast({
  ...
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
        "group pointer-events-auto relative flex w-full items-center justify-between gap-2 overflow-hidden rounded-lg border border-border bg-surface-raised p-4 pr-6 text-foreground shadow-lg transition-all",
